 ...
 */
public class FinishAppointmentPresenter implements
    FinishAppointmentView.FinishAppointmentViewListener {

  private FinishAppointmentModel finishAppointmentModel;
  private FinishAppointmentView finishAppointmentView;

  public FinishAppointmentPresenter(FinishAppointmentModel finishAppointmentModel,
      FinishAppointmentView finishAppointmentView) {
