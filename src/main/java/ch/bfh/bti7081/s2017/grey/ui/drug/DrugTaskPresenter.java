 ...
 * @author Joel
 */
public class DrugTaskPresenter implements DrugTaskListViewListener, DrugTaskFormViewListener,
    ModelCollectionListener {
   ...
   */
  public DrugTaskPresenter(DrugTaskListView drugTaskListView,
      DrugTaskModelCollection drugTaskModelCollection) {
  ...
  public void onFormClosed() {
    ...
    try {
      drugTaskModelCollection
          .addDrugTask(drugTaskFormView.getTaskName(), drugTaskFormView.getDrug(),
              drugTaskFormView.getAmount(), drugTaskFormView.getAmountUnit());
    } catch (MissingAppointmentException e) {
      e.printStackTrace();
