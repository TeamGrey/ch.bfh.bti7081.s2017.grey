...
public class PatientViewImpl extends HorizontalLayout implements PatientView, View {
  ...
  public PatientViewImpl() {
    ...
    editDrugButton
        .addClickListener((Button.ClickEvent e) -> drugWindow.open(drugOptions, drugArray));
    editHabitButton
        .addClickListener((Button.ClickEvent e) -> habitWindow.open(habitOptions, habitArray));
