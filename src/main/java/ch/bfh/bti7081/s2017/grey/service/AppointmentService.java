...
public interface AppointmentService {
   ...
   * @return List of appointments
   */
  List<Appointment> findAppointmentsByStaffAndDateRange(Staff staff, LocalDateTime start,
      LocalDateTime end);
   ...
   */
  Appointment createAppointment(Patient patient, Staff staff, String description, String title,
      LocalDateTime date, LocalDateTime end);
   ...
   */
  Appointment delayAppointment(Appointment appointment, LocalDateTime newDate,
